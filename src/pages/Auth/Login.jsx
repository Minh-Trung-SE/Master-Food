...
export const Login = () => {
    return (
        <div className='min-h-screen bg-primary-bg flex items-center justify-center'>
            <div className='bg-white mx-4 w-full md:w-5/12 sm:w-8/12 max-w-xl p-12 rounded'>
                <div className='w-full flex flex-col'>
                    ...
                    <div className='w-full mt-4'>
                        ...
                        <div className='flex justify-between'>
                            <div className='flex items-center bg-[#0b5ed7] flex-1 py-2 px-3 rounded hover:cursor-pointer'>
                            ...
                            <div className='ml-4 flex items-center bg-[#dd4b39] flex-1 py-2 px-3 rounded hover:cursor-pointer'>
                                <div className="w-fit h-fit mr-4 ">
